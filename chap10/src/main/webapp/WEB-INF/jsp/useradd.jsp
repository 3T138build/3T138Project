...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm"  method="post" action="${pageContext.request.contextPath }/userSave"
                   enctype="multipart/form-data" >
				<input type="hidden" name="method" value="add">
                <input type="hidden" name="createdBy" value="${sessionScope.smbmsUser.id}">
                ...
                <div>
                    ...
                    <input type="text" name="userName" id="userName" value="sdf">
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="15113643467">
					<font color="red"></font>
                </div>
                <div>
                    <label for="address">用户地址：</label>
                   <input name="address" id="address"  value="trt">
                </div>
                <div>
                    <label >用户角色：</label>
                    <!-- 列出所有的角色分类 -->
